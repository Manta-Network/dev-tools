...
import type { BTreeMap, Bytes, Compact, Enum, Null, Option, Result, Struct, Text, U8aFixed, Vec, bool, u128, u16, u32, u64, u8 } from '@polkadot/types';
...
declare module '@polkadot/types/lookup' {
  ...
  /** @name CalamariVestingEvent (95) */
  export interface CalamariVestingEvent extends Enum {
    readonly isVestingUpdated: boolean;
    readonly asVestingUpdated: ITuple<[AccountId32, u128]>;
    readonly isVestingCompleted: boolean;
    readonly asVestingCompleted: AccountId32;
    readonly isVestingScheduleUpdated: boolean;
    readonly asVestingScheduleUpdated: Vec<u64>;
  }
  ...
  /** @name PolkadotPrimitivesV1PersistedValidationData (121) */
  ...
  /** @name PolkadotPrimitivesV1UpgradeRestriction (124) */
  export interface PolkadotPrimitivesV1UpgradeRestriction extends Enum {
    readonly isPresent: boolean;
  }

  /** @name CumulusPalletParachainSystemRelayStateSnapshotMessagingStateSnapshot (125) */
  ...
  /** @name FrameSupportWeightsWeightToFeeCoefficient (166) */
  ...
  /** @name PalletDemocracyPreimageStatus (170) */
  ...
  /** @name PalletDemocracyReferendumInfo (172) */
  ...
  /** @name PalletDemocracyReferendumStatus (173) */
  ...
  /** @name PalletDemocracyVoteVoting (175) */
  ...
  /** @name PalletDemocracyVoteAccountVote (178) */
  ...
  /** @name PalletDemocracyReleases (185) */
  ...
  /** @name PalletCollatorSelectionCall (199) */
  ...
  export interface PalletSessionCall extends Enum {
    ...
    readonly asSetKeys: {
      readonly keys_: CalamariRuntimeOpaqueSessionKeys;
      readonly proof: Bytes;
    } & Struct;
    readonly isPurgeKeys: boolean;
  }

  /** @name CalamariRuntimeOpaqueSessionKeys (201) */
  export interface CalamariRuntimeOpaqueSessionKeys extends Struct {
    readonly aura: SpConsensusAuraSr25519AppSr25519Public;
  }

  /** @name SpConsensusAuraSr25519AppSr25519Public (202) */
  export interface SpConsensusAuraSr25519AppSr25519Public extends SpCoreSr25519Public {}

  /** @name SpCoreSr25519Public (203) */
  ...
  /** @name CalamariVestingCall (238) */
  export interface CalamariVestingCall extends Enum {
    readonly isUpdateVestingSchedule: boolean;
    readonly asUpdateVestingSchedule: {
      readonly newSchedule: Vec<u64>;
    } & Struct;
    readonly isVest: boolean;
    readonly isVestedTransfer: boolean;
    readonly asVestedTransfer: {
      readonly target: MultiAddress;
      readonly lockedAmount: Compact<u128>;
    } & Struct;
  }

  /** @name PalletCollectiveVotes (239) */
  ...
  /** @name PalletCollectiveError (240) */
  ...
  /** @name PalletMembershipError (241) */
  ...
  /** @name SpCoreCryptoKeyTypeId (255) */
  export interface SpCoreCryptoKeyTypeId extends U8aFixed {}

  /** @name PalletSessionError (256) */
  ...
  /** @name PalletSchedulerScheduledV2 (262) */
  export interface PalletSchedulerScheduledV2 extends Struct {
    readonly maybeId: Option<Bytes>;
    readonly priority: u8;
    readonly call: Call;
    readonly maybePeriodic: Option<ITuple<[u32, u32]>>;
    readonly origin: CalamariRuntimeOriginCaller;
  }

  /** @name CalamariRuntimeOriginCaller (263) */
  export interface CalamariRuntimeOriginCaller extends Enum {
  ...
  /** @name PalletCollectiveRawOrigin (265) */
  ...
  /** @name CumulusPalletXcmOrigin (268) */
  ...
  /** @name PalletSchedulerReleases (270) */
  export interface PalletSchedulerReleases extends Enum {
    readonly isV1: boolean;
    readonly isV2: boolean;
  }

  /** @name PalletSchedulerError (271) */
  ...
  /** @name CumulusPalletXcmpQueueInboundStatus (274) */
  export interface CumulusPalletXcmpQueueInboundStatus extends Enum {
    readonly isOk: boolean;
    readonly isSuspended: boolean;
  }

  /** @name PolkadotParachainPrimitivesXcmpMessageFormat (277) */
  ...
  /** @name CumulusPalletXcmpQueueOutboundStatus (281) */
  export interface CumulusPalletXcmpQueueOutboundStatus extends Enum {
    readonly isOk: boolean;
    readonly isSuspended: boolean;
  }

  /** @name CumulusPalletXcmpQueueQueueConfigData (283) */
  ...
  /** @name CumulusPalletXcmError (286) */
  export type CumulusPalletXcmError = Null;

  /** @name CumulusPalletDmpQueueConfigData (287) */
  export interface CumulusPalletDmpQueueConfigData extends Struct {
    readonly maxIndividual: u64;
  }

  /** @name CumulusPalletDmpQueuePageIndexData (288) */
  ...
  /** @name CumulusPalletDmpQueueError (291) */
  ...
  /** @name PalletSudoError (297) */
  export interface PalletSudoError extends Enum {
    readonly isRequireSudo: boolean;
  }

  /** @name CalamariVestingError (302) */
  export interface CalamariVestingError extends Enum {
    readonly isNotVesting: boolean;
    readonly isExistingVestingSchedule: boolean;
    readonly isAmountLow: boolean;
    readonly isBalanceLow: boolean;
    readonly isInvalidSchedule: boolean;
    readonly isInvalidScheduleLength: boolean;
    readonly isUnsortedSchedule: boolean;
    readonly isClaimTooEarly: boolean;
  }
  ...
  /** @name FrameSystemExtensionsCheckSpecVersion (311) */
  export type FrameSystemExtensionsCheckSpecVersion = Null;

  /** @name FrameSystemExtensionsCheckTxVersion (312) */
  export type FrameSystemExtensionsCheckTxVersion = Null;

  /** @name FrameSystemExtensionsCheckGenesis (313) */
  export type FrameSystemExtensionsCheckGenesis = Null;

  /** @name FrameSystemExtensionsCheckNonce (316) */
  export interface FrameSystemExtensionsCheckNonce extends Compact<u32> {}

  /** @name FrameSystemExtensionsCheckWeight (317) */
  export type FrameSystemExtensionsCheckWeight = Null;

  /** @name PalletTransactionPaymentChargeTransactionPayment (318) */
  export interface PalletTransactionPaymentChargeTransactionPayment extends Compact<u128> {}

  /** @name CalamariRuntimeRuntime (319) */
  export type CalamariRuntimeRuntime = Null;
